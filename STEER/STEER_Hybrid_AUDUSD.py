...
def steer_ols(swaps="", FX="", local_equity="", yc="", global_eq="", cb="", days=378, weights=[1], G10=False, US=False):
    ...
    plt.savefig("AUDUSD_STEER.png")
    plt.show()




steer_ols(swaps=["USSO2 Curncy", "ADSO2 Curncy"], FX="USDAUD Curncy", yc=["GTAUD10YR Corp", "ADSOC Curncy", "USGG10YR Index", "USSOC BGN Curncy"], local_equity="ASX Index", global_eq="MXWO Index", cb=["CL1 COMB Comdty"], weights=[1], G10=True)