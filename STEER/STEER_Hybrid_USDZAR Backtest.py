...
def steer_ols(swaps="", FX="", local_equity="", yc="", global_eq="", cb="", days=390, weights=[1], G10=False, US=False):
    ...
    zeros = pd.DataFrame(0, index=fx2.index, columns=["Signal"])
...
df, z, y = steer_ols(swaps=["USOSFR3 Curncy", "SASW3 Curncy"], FX="USDZAR Curncy", yc="CSOAF1U5 Curncy", local_equity="JALSH Index", global_eq="MXWO Index", cb=["XAU Curncy", "WBCOIRON Index", "XPT Curncy", "WBCOCSAF Index"], weights=[0.232, 0.232, 0.188, 0.235])
