...
steer_ols(swaps=["USSO2 Curncy", "TBSWH2 Curncy"], FX="USDTHB Curncy", yc="CTHAI1U5 Curncy", local_equity="SET Index", global_eq="MXWO Index", cb=["CL1 COMB Comdty"], weights=[1])